...
class HDC_op
{
    public:
        ...
        float predict(float test_data[DS_TEST_SIZE][DS_FEATURE_SIZE], int test_labels[DS_TEST_SIZE], int num_classes, float *quantized_levels,HV BaseHVs[DS_FEATURE_SIZE], HV LevelHVs[HD_LV_LEN], HV ClassHVs[DS_CLASSES_SIZE], int clipping_encoding, int verbose, int n_gram, int n_gram_size,int encoding_technique)
        {
