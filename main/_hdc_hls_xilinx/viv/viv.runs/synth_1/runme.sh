...
HD_PWD='C:/Reconfigurable_HDC_Platform_old/main/_hdc_hls_xilinx/viv/viv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdv_engine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdv_engine.tcl
