; ModuleID = 'C:/Reconfigurable_HDC_Platform_old/main/_hdc_hls_xilinx/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%struct.chv_t = type { [64 x %"struct.ap_uint<1>"] }
...
entry:
  ...
  %chv_i_copy = alloca i64, align 512
  ...
  call fastcc void @copy_in(i1* nonnull %nrst_i, i1* nonnull align 512 %nrst_i_copy, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* nonnull %sdata_i, i8* %sdata_i_copy.data, i1* %sdata_i_copy.keep, i1* %sdata_i_copy.strb, i1* %sdata_i_copy.user, i1* %sdata_i_copy.last, i1* %sdata_i_copy.id, i1* %sdata_i_copy.dest, %struct.chv_p_t* nonnull %chv_i, i64* nonnull align 512 %chv_i_copy, %struct.chv_p_t* nonnull %bhv_i, i64* nonnull align 512 %bhv_i_copy, %struct.chv_p_t* nonnull %lhv_i, i64* nonnull align 512 %lhv_i_copy, %struct.pred_class_t* nonnull %pred_class_o, i6* nonnull align 512 %pred_class_o_copy, %struct.sys_status_t* nonnull %status_o, i5* nonnull align 512 %status_o_copy)
  call void @apatb_hdv_engine_hw(i1* %nrst_i_copy, %struct.op_mode_t* %op_mode_i, %struct.frame_in_t* %frame_in, i8* %sdata_i_copy.data, i1* %sdata_i_copy.keep, i1* %sdata_i_copy.strb, i1* %sdata_i_copy.user, i1* %sdata_i_copy.last, i1* %sdata_i_copy.id, i1* %sdata_i_copy.dest, i64* %chv_i_copy, i64* %bhv_i_copy, i64* %lhv_i_copy, i6* %pred_class_o_copy, i5* %status_o_copy)
  call void @copy_back(i1* %nrst_i, i1* %nrst_i_copy, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* %sdata_i, i8* %sdata_i_copy.data, i1* %sdata_i_copy.keep, i1* %sdata_i_copy.strb, i1* %sdata_i_copy.user, i1* %sdata_i_copy.last, i1* %sdata_i_copy.id, i1* %sdata_i_copy.dest, %struct.chv_p_t* %chv_i, i64* %chv_i_copy, %struct.chv_p_t* %bhv_i, i64* %bhv_i_copy, %struct.chv_p_t* %lhv_i, i64* %lhv_i_copy, %struct.pred_class_t* %pred_class_o, i6* %pred_class_o_copy, %struct.sys_status_t* %status_o, i5* %status_o_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(i1* noalias readonly "unpacked"="0", i1* noalias align 512 "unpacked"="1", %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* noalias "unpacked"="2", i8* noalias "unpacked"="3.0" %_V_data_V, i1* noalias "unpacked"="3.1" %_V_keep_V, i1* noalias "unpacked"="3.2" %_V_strb_V, i1* noalias "unpacked"="3.3" %_V_user_V, i1* noalias "unpacked"="3.4" %_V_last_V, i1* noalias "unpacked"="3.5" %_V_id_V, i1* noalias "unpacked"="3.6" %_V_dest_V, %struct.chv_p_t* noalias readonly "unpacked"="4", i64* noalias align 512 "unpacked"="5", %struct.chv_p_t* noalias readonly "unpacked"="6", i64* noalias align 512 "unpacked"="7", %struct.chv_p_t* noalias readonly "unpacked"="8", i64* noalias align 512 "unpacked"="9", %struct.pred_class_t* noalias readonly "unpacked"="10", i6* noalias nocapture align 512 "unpacked"="11.0", %struct.sys_status_t* noalias readonly "unpacked"="12", i5* noalias nocapture align 512 "unpacked"="13.0") unnamed_addr #1 {
entry:
  call fastcc void @onebyonecpy_hls.p0i1(i1* align 512 %1, i1* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>.51"(i8* %_V_data_V, i1* %_V_keep_V, i1* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* %2)
  call fastcc void @onebyonecpy_hls.p0struct.chv_p_t(i64* align 512 %4, %struct.chv_p_t* %3)
  call fastcc void @onebyonecpy_hls.p0struct.chv_p_t(i64* align 512 %6, %struct.chv_p_t* %5)
  call fastcc void @onebyonecpy_hls.p0struct.chv_p_t(i64* align 512 %8, %struct.chv_p_t* %7)
  call fastcc void @onebyonecpy_hls.p0struct.pred_class_t.16(i6* align 512 %10, %struct.pred_class_t* %9)
...
; Function Attrs: argmemonly noinline norecurse
define void @arraycpy_hls.p0a1struct.chv_t([1 x %struct.chv_t]* %dst, [1 x %struct.chv_t]* readonly %src, i64 %num) local_unnamed_addr #5 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @"arraycpy_hls.p0a64struct.ap_uint<1>"([64 x %"struct.ap_uint<1>"]* %dst.addr.02, [64 x %"struct.ap_uint<1>"]* %src.addr.01, i64 64)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(i1* noalias "unpacked"="0", i1* noalias readonly align 512 "unpacked"="1", %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* noalias "unpacked"="2", i8* noalias "unpacked"="3.0" %_V_data_V, i1* noalias "unpacked"="3.1" %_V_keep_V, i1* noalias "unpacked"="3.2" %_V_strb_V, i1* noalias "unpacked"="3.3" %_V_user_V, i1* noalias "unpacked"="3.4" %_V_last_V, i1* noalias "unpacked"="3.5" %_V_id_V, i1* noalias "unpacked"="3.6" %_V_dest_V, %struct.chv_p_t* noalias "unpacked"="4", i64* noalias readonly align 512 "unpacked"="5", %struct.chv_p_t* noalias "unpacked"="6", i64* noalias readonly align 512 "unpacked"="7", %struct.chv_p_t* noalias "unpacked"="8", i64* noalias readonly align 512 "unpacked"="9", %struct.pred_class_t* noalias "unpacked"="10", i6* noalias nocapture readonly align 512 "unpacked"="11.0", %struct.sys_status_t* noalias "unpacked"="12", i5* noalias nocapture readonly align 512 "unpacked"="13.0") unnamed_addr #6 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0struct.chv_p_t.23(%struct.chv_p_t* %3, i64* align 512 %4)
  call fastcc void @onebyonecpy_hls.p0struct.chv_p_t.23(%struct.chv_p_t* %5, i64* align 512 %6)
  call fastcc void @onebyonecpy_hls.p0struct.chv_p_t.23(%struct.chv_p_t* %7, i64* align 512 %8)
  call fastcc void @onebyonecpy_hls.p0struct.pred_class_t(%struct.pred_class_t* %9, i6* align 512 %10)
  call fastcc void @onebyonecpy_hls.p0struct.sys_status_t.9(%struct.sys_status_t* %11, i5* align 512 %12)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0struct.sys_status_t.9(%struct.sys_status_t* noalias "unpacked"="0" %dst, i5* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0struct.pred_class_t.16(i6* noalias nocapture align 512 "unpacked"="0.0" %dst, %struct.pred_class_t* noalias readonly "unpacked"="1" %src) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0struct.chv_p_t.23(%struct.chv_p_t* noalias %dst, i64* noalias readonly align 512 %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  ...
  call void @arraycpy_hls.p0a1struct.chv_t.26([1 x %struct.chv_t]* %dst.0, i64* nonnull %src, i64 0, i64 1)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @arraycpy_hls.p0a1struct.chv_t.26([1 x %struct.chv_t]* %dst, i64* readonly %src, i64 %src_idx, i64 %num) local_unnamed_addr #5 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %4 = add i64 %src_idx, %3
  %dst.addr.02 = getelementptr [1 x %struct.chv_t], [1 x %struct.chv_t]* %dst, i64 0, i64 %for.loop.idx4, i32 0
  call void @"arraycpy_hls.p0a64struct.ap_uint<1>.29"([64 x %"struct.ap_uint<1>"]* %dst.addr.02, i64* %src, i64 %4, i64 64)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx4, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a64struct.ap_uint<1>.29"([64 x %"struct.ap_uint<1>"]* %dst, i64* readonly %src, i64 %src_idx, i64 %num) local_unnamed_addr #5 {
entry:
  %0 = icmp eq i64* %src, null
  %1 = icmp eq [64 x %"struct.ap_uint<1>"]* %dst, null
  %2 = or i1 %1, %0
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0struct.chv_p_t(i64* noalias align 512 %dst, %struct.chv_p_t* noalias readonly %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  ...
  call void @arraycpy_hls.p0a1struct.chv_t.37(i64* nonnull %dst, i64 0, [1 x %struct.chv_t]* %src.0, i64 1)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @arraycpy_hls.p0a1struct.chv_t.37(i64* %dst, i64 %dst_idx, [1 x %struct.chv_t]* readonly %src, i64 %num) local_unnamed_addr #5 {
entry:
  %0 = icmp eq [1 x %struct.chv_t]* %src, null
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %3 = mul i64 64, %for.loop.idx4
  %4 = add i64 %dst_idx, %3
  call void @"arraycpy_hls.p0a64struct.ap_uint<1>.40"(i64* %dst, i64 %4, [64 x %"struct.ap_uint<1>"]* %src.addr.01, i64 64)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx4, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a64struct.ap_uint<1>.40"(i64* %dst, i64 %dst_idx, [64 x %"struct.ap_uint<1>"]* readonly %src, i64 %num) local_unnamed_addr #5 {
entry:
  %0 = icmp eq [64 x %"struct.ap_uint<1>"]* %src, null
  %1 = icmp eq i64* %dst, null
  %2 = or i1 %1, %0
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>.51"(i8* noalias "unpacked"="0.0" %dst_V_data_V, i1* noalias "unpacked"="0.1" %dst_V_keep_V, i1* noalias "unpacked"="0.2" %dst_V_strb_V, i1* noalias "unpacked"="0.3" %dst_V_user_V, i1* noalias "unpacked"="0.4" %dst_V_last_V, i1* noalias "unpacked"="0.5" %dst_V_id_V, i1* noalias "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* noalias %src) unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>.54"(i8* %dst_V_data_V, i1* %dst_V_keep_V, i1* %dst_V_strb_V, i1* %dst_V_user_V, i1* %dst_V_last_V, i1* %dst_V_id_V, i1* %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>.54"(i8* noalias nocapture "unpacked"="0.0" %_V_data_V, i1* noalias nocapture "unpacked"="0.1" %_V_keep_V, i1* noalias nocapture "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture "unpacked"="0.3" %_V_user_V, i1* noalias nocapture "unpacked"="0.4" %_V_last_V, i1* noalias nocapture "unpacked"="0.5" %_V_id_V, i1* noalias nocapture "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* noalias nocapture) unnamed_addr #4 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"
...
declare void @apatb_hdv_engine_hw(i1*, %struct.op_mode_t*, %struct.frame_in_t*, i8*, i1*, i1*, i1*, i1*, i1*, i1*, i64*, i64*, i64*, i6*, i5*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(i1* noalias "unpacked"="0", i1* noalias readonly align 512 "unpacked"="1", %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* noalias "unpacked"="2", i8* noalias "unpacked"="3.0" %_V_data_V, i1* noalias "unpacked"="3.1" %_V_keep_V, i1* noalias "unpacked"="3.2" %_V_strb_V, i1* noalias "unpacked"="3.3" %_V_user_V, i1* noalias "unpacked"="3.4" %_V_last_V, i1* noalias "unpacked"="3.5" %_V_id_V, i1* noalias "unpacked"="3.6" %_V_dest_V, %struct.chv_p_t* noalias "unpacked"="4", i64* noalias readonly align 512 "unpacked"="5", %struct.chv_p_t* noalias "unpacked"="6", i64* noalias readonly align 512 "unpacked"="7", %struct.chv_p_t* noalias "unpacked"="8", i64* noalias readonly align 512 "unpacked"="9", %struct.pred_class_t* noalias "unpacked"="10", i6* noalias nocapture readonly align 512 "unpacked"="11.0", %struct.sys_status_t* noalias "unpacked"="12", i5* noalias nocapture readonly align 512 "unpacked"="13.0") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"(%"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* %2, i8* %_V_data_V, i1* %_V_keep_V, i1* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V)
  call fastcc void @onebyonecpy_hls.p0struct.pred_class_t(%struct.pred_class_t* %9, i6* align 512 %10)
  call fastcc void @onebyonecpy_hls.p0struct.sys_status_t.9(%struct.sys_status_t* %11, i5* align 512 %12)
...
define void @hdv_engine_hw_stub_wrapper(i1*, %struct.op_mode_t*, %struct.frame_in_t*, i8*, i1*, i1*, i1*, i1*, i1*, i1*, i64*, i64*, i64*, i6*, i5*) #7 {
entry:
  %15 = alloca %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"
  %16 = alloca %struct.chv_p_t
  %17 = alloca %struct.chv_p_t
  %18 = alloca %struct.chv_p_t
  %19 = alloca %struct.pred_class_t
  %20 = alloca %struct.sys_status_t
  call void @copy_out(i1* null, i1* %0, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* %15, i8* %3, i1* %4, i1* %5, i1* %6, i1* %7, i1* %8, i1* %9, %struct.chv_p_t* %16, i64* %10, %struct.chv_p_t* %17, i64* %11, %struct.chv_p_t* %18, i64* %12, %struct.pred_class_t* %19, i6* %13, %struct.sys_status_t* %20, i5* %14)
  call void @hdv_engine_hw_stub(i1* %0, %struct.op_mode_t* %1, %struct.frame_in_t* %2, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* %15, %struct.chv_p_t* %16, %struct.chv_p_t* %17, %struct.chv_p_t* %18, %struct.pred_class_t* %19, %struct.sys_status_t* %20)
  call void @copy_in(i1* null, i1* %0, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"* %15, i8* %3, i1* %4, i1* %5, i1* %6, i1* %7, i1* %8, i1* %9, %struct.chv_p_t* %16, i64* %10, %struct.chv_p_t* %17, i64* %11, %struct.chv_p_t* %18, i64* %12, %struct.pred_class_t* %19, i6* %13, %struct.sys_status_t* %20, i5* %14)
  ret void
}

declare void @hdv_engine_hw_stub(i1*, %struct.op_mode_t*, %struct.frame_in_t*, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1>, 0>"*, %struct.chv_p_t*, %struct.chv_p_t*, %struct.chv_p_t*, %struct.pred_class_t*, %struct.sys_status_t*)
