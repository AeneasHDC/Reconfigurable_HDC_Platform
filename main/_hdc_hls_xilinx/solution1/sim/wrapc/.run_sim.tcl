...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hdv_engine.autotvin.dat"
	set constFileTvOut       "hdv_engine.autotvout.dat"
	set constFileHdlTvIn     "hdv_engine.autohdltvin.dat"
	set constFileHdlTvOut    "hdv_engine.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
