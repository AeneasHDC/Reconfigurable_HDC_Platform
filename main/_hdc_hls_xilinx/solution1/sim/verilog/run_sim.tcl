...
if {[file isfile hdv_engine.autotvin.dat]} {
	file delete -force hdv_engine.autotvin.dat
}

if {[file isfile hdv_engine.autotvout.dat]} {
	file delete -force hdv_engine.autotvout.dat
}
